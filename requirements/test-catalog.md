...
| `ADM-AUTH-###` | Platform admin authority / control-plane access |
| `ADM-DATA-###` | Admin read-model safety / PII minimisation |
| `ADM-FIN-###` | Admin financial mutation boundary |
| `ADM-AUD-###` | Admin audit read-only / append-only |
