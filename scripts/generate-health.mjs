...
const health = {
  ...
  implementation: {
      ...
      : phaseHCanonicalPass
        ? phaseIPlatformStarted
          ...
          : phaseIGatePass
            ...
            : 'not_started'
        : undefined,
    mvpAcceptance: 'not_accepted_external_implementation_live_evidence',
    mvpAcceptanceBlockerCount: 0,
    mvpAcceptanceBlockerCategories: {
      EXTERNAL_VENDOR_DECISION: 0,
      EXTERNAL_IMPLEMENTATION: 4,
      LIVE_EVIDENCE: 2,
    },
    localMvpBlockers: 0,
    track1a: 'pass',
    ...
    nextActivity: 'ADR_040_MANAGED_SECRETS_PLATFORM_IMPLEMENTATION',
    track2a: 'pass',
    track2: 'pass_od008_stripe_connect',
    track2b: 'pass_od009_stripe_payouts',
    track2c: 'pass_od025_managed_secrets',
    track3: 'pass_od023_auth0',
    ...
    od025: 'resolved_adr040_aws_secrets_kms_split',
    od023: 'resolved_adr041_auth0',
    stripePaymentAdapter: 'external_implementation_pending',
    stripeSettlementAdapter: 'external_implementation_pending',
    managedSecretsBackend: 'external_implementation_pending',
    auth0AuthenticationProvider: 'external_implementation_pending',
