...
const decisions = [
  ...
  { id: 'OD-031', slug: 'webhook-retry-bounds', title: 'Webhook retry schedule / attempt bounds', category: 'api', blockingStage: 'development', why: 'Delivery worker', status: 'resolved', related: ['docs/decisions/ADR-009-signed-at-least-once-webhooks.md', 'docs/decisions/ADR-030-merchant-webhook-contract-signing-and-delivery.md'], resolvedBy: 'ADR-030' },
