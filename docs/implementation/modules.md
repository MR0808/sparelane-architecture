...
| **Settlement** | Settlement lifecycle | settlements, batches, instructions | Create/Submit/Reconcile | Settlement* events | Ledger (read eligibility), Settlement adapter, Outbox | Mutate payment attempts; reverse COLLECTED on partner outage |
