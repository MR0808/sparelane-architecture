...
| **Notifications** | Email/SMS — **deferred** past G0/G1 (OD-005) | notification prefs/templates (not yet modelled) | NotifyConsumer | NotificationQueued | Email/SMS adapters | Financial state mutation; invent contact email from IdP |
