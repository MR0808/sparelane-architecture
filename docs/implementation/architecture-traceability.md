...
| ADR-034 Durable DLQ and operator replay | [dead-letter-handling](../operations/dead-letter-handling.md), [admin-access](../security/admin-access.md), [financial-integrity](../security/financial-integrity.md), SEQ-OPS-003/005; [ADR-030](../decisions/ADR-030-merchant-webhook-contract-signing-and-delivery.md) §16 | Operations (`DeadLetterItem`); Admin BFF; notification-worker (`ReplayWebhookDelivery`) | H2 gate PASS; platform H2 not started; FUN-ADM-007/008; NFR-SEC-011; NFR-REL-006; NFR-OPS-006; NFR-PRIV-006 |
