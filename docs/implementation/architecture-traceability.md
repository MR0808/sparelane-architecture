...
| ADR-033 Privileged admin grant management | [admin-access](../security/admin-access.md), [admin-grant-dual-control](../design/security/admin-grant-dual-control.md), SEQ-SEC-006; [authorisation](../security/authorisation.md), [audit](../security/audit.md) | Identity (PlatformAdminGrant lifecycle); PrivilegedActionRequest/Approval; Admin BFF | H1 gate PASS; platform H1 PASS (local); FUN-ADM-005/006; NFR-SEC-009/010; ADM-PRIV/DUAL/GRANT tests |
| ADR-034 Durable DLQ and operator replay | [dead-letter-handling](../operations/dead-letter-handling.md), [admin-access](../security/admin-access.md), [financial-integrity](../security/financial-integrity.md), SEQ-OPS-003/005; [ADR-030](../decisions/ADR-030-merchant-webhook-contract-signing-and-delivery.md) §16 | Operations (`DeadLetterItem`); Admin BFF; notification-worker (`ReplayWebhookDelivery`) | H2 gate PASS; platform H2 PASS (local); FUN-ADM-007/008; NFR-SEC-011; NFR-REL-006; NFR-OPS-006; NFR-PRIV-006 |
...
| ADR-041 (Superseded) / ADR-042 (Superseded) / ADR-043 Better Auth-all | [authentication](../security/authentication.md), [admin-access](../security/admin-access.md), [greenfield-better-auth-all-gate](../decisions/greenfield-better-auth-all-gate.md), [unified checklist](better-auth-unified-platform-checklist.md) | BetterAuthAuthenticationProvider; AuthenticationAssurance; ExternalIdentity; AUTH-B* | BETTER-AUTH-PRIV-001 / REC-001; OD-024 evidence pending; Auth0 LIVE not MVP-mandatory |
